namespace Procurement.ViewModel.Filters.ForumExport
{
    class StrengthFilter : OrStatFilter
    {
        ...
        public StrengthFilter()
            : base("Increased Strength", "Strength", "to Strength", "increased Strength", "to all Attributes", "increased Attributes")
        { }
    }
    ...
    class IntelligenceFilter : OrStatFilter
    {
        ...
        public IntelligenceFilter()
            : base("Increased Intelligence", "Intelligence", "to Intelligence", "to Strength and Intelligence", "to Dexterity and Intelligence", "increased Intelligence", "to all Attributes", "increased Attributes")
        { }
    }
